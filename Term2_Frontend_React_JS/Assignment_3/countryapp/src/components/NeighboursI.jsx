...
const NeighboursI = ({countries, countryMap}) => {
    const filterCountries = countries.filter(country => {           // goes through the list and filters based on given filter parameters
        ...
        return neighbourNames.some(name => name.startsWith('I'));                       // returns each country that starts with A
    });
